...
class AccountController extends Controller
{
    ...
    //now Authentecate the login user
    ...
    public function updateProfile(Request $request)
{
    ...
    if ($validator->passes()) {
        ...
        if ($user->save()) {
            ...
            return response()->json([
                'status' => true,
                'message' => session('success') // Include the flash message in the response
            ]);
        } else {
            return response()->json([
                'status' => false,
    ...
    public function saveJob(Request $request){
        $rules =[
            ...
            'company_name' => 'required|min:2|max:75',
    ...
    public function deleteJob(Request $request){
        ...
        if($job == null){
        session()->flash('error','Job Updated Successfully.');
        return response()->json([
            'status' => true,
        ]);
    }
    ...
    public function processforgotPassword(Request $request) {
        ...
        $mailData = [
            'token' => $token,
            'user' => $user,
            'subject' => 'You are requested to change your password'
    ...
    public function processResetPassword(Request $request){
        ...
        return redirect()->route('account.login')->with('success', 'Password has been changed successfully.');
