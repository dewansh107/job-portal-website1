            ...
            <div class="col-lg-9">
                ...
                <div class="card border-0 shadow mb-4 ">
                    <div class="card-body card-form p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="textarea" name="description" id="description" cols="5" rows="5"
                                placeholder="Description">value="{{$job->description}}"</textarea>
                                <p></p>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Benefits</label>
                            <textarea class="textarea" name="benefits" id="benefits" cols="5" rows="5"
                                placeholder="Benefits">value="{{$job->benefits}}"</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Responsibility</label>
                            <textarea class="textarea" name="responsibility" id="responsibility" cols="5"
                                rows="5" placeholder="Responsibility">value="{{$job->responsibility}}"</textarea>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="card-footer  p-4">
                        <button type="submiit" class="btn btn-primary">Update Job</button>
                    </div>
                </div>
            </form>
            ...
            success: function(response) {
                ...
                if (response.status == true) {
                    ...
                    if (errors.title) {
                        ...
                        $("#tiitle").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html('');
                    }
